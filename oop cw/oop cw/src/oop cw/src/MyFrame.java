...
//The main JFrame class for the shopping manager GUI
public class MyFrame extends JFrame implements ActionListener {
    ...
    // Method to update the data displayed in the main product table
    private void updateTableData() {
        // Clears the current table data
        this.tableModel.setRowCount(0);
        // Iterates through all products and adds them to the table based on the selected category
        ...
        while(true) {
            ...
            // Adds product information to the table model
    ...
    // Method to get additional product information as a string
    private String getProductInfo(Product product) {
        String var10000;
        // Retrieves additional information based on the product type
        if (product instanceof Electronics) {
            var10000 = ((Electronics)product).getBrand();
            return "Brand: " + var10000 + ", Warranty: " + ((Electronics)product).getwarrantyPeriod() + " years, Available Items: " + product.getAvailableItems();
    ...
    // Method to convert additional product information from a string to a Product object
    private Product getProductInfo(String info) {
        // Parses the product information string and creates a new product object
        ...
        if (type.contains("Brand")) {
            ...
            // Extracts and validates the warranty information
            try {
                String[] warrantyParts = color.split(" ");
                if (warrantyParts.length > 0) {
                    double var7 = Double.parseDouble(warrantyParts[0]);
                } else {
    ...
    MyFrame(WestminsterShoppingManager shoppingManager) {
        // Initializes the frame and sets its properties
    ...
    // Method to highlight low-stock products in the product table
    ...
    // Method to update the details in the shopping cart
